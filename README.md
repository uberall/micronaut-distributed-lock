...
```
implementation "com.uberall:micronaut-distributed-lock-core:1.2.0"
```

and one runtime implementation to your pom.xml/build.gradle

```
runtime "com.uberall:micronaut-distributed-lock-data-jdbc:1.2.0"
```
...
```
runtime "com.uberall:micronaut-distributed-lock-data-redis:1.2.0"
```
